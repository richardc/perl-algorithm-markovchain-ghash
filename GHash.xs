...
void 
increment_seen(SV* obj, char *stub, char *original_next)
  CODE:
{
    IM* im       = (IM*) SvIV(phash_value(SvRV(obj), "_cstuff"));
...
int
sequence_known(SV* obj, char *stub)
  CODE:
    IM* im = (IM*) SvIV(phash_value(SvRV(obj), "_cstuff"));
